  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <div className="flex flex-col lg:flex-row h-[calc(100vh-80px)] gap-0">
        <div className="w-full lg:w-80 bg-slate-800 p-2 lg:p-6 space-y-2 lg:space-y-6 order-2 lg:order-1 border-t lg:border-t-0 border-slate-700">
          {/* Manual/Auto Toggle */}
        ...
        <div className="flex-1 order-1 lg:order-2">
          <div className="relative bg-slate-800 h-80 sm:h-96 md:h-[500px] lg:h-full lg:rounded-lg overflow-hidden">
            {/* Ball trails */}
            {balls.map((ball) =>
